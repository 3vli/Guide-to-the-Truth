...
export function Navbar() {
  ...
  return (
    <header className="w-full py-6 pt-10 px-20 bg-neutral-200 flex justify-between items-center ">
      ...
      <nav
        className={
          toggle
            ? "h-40 w-40 absolute left-1/2 top-32 text-center items-center justify-center gap-3 rounded-2xl flex flex-col bg-neutral-400 "
